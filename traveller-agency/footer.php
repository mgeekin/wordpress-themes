	        ...
	        <div class="site-info col-lg-7 col-md-7 col-12">
	            <div class="footer-menu-left">
	            	<?php  if( ! get_theme_mod('traveller_agency_footer_text_setting') ){ ?>
          			...
          			<span>
                    <a class="footer-link" target="_blank" href="<?php echo esc_url('https://www.themagnifico.net/themes/free-traveller-wordpress-theme/'); ?>">
				           	<?php
					    ...
					    <span>
					    	<a href="<?php echo esc_url('https://www.themagnifico.net/'); ?>">
								<?php
				            		echo esc_html( ' by TheMagnifico', 'traveller-agency' );
				            	?>
						    </a>
					    </span>
					<?php }?>
